...
export default function Greetings() {
    return (
        <Layout>
            {/* Hero Section */}
            <Section variant="gradient" padding="lg" className="text-white relative overflow-hidden">
            ...
            <Section padding="lg" className="bg-gray-50">
                <Container>
                    <div className="max-w-4xl mx-auto -mt-20 relative z-20">
                        <Card variant="elevated" className="p-10 md:p-16 bg-white shadow-xl border-t-4 border-sookmyung-blue-900">
                            {/* Decorative Icon */}
                            ...
                            {/* Content */}
                            <div className="prose prose-lg max-w-none text-gray-700 leading-loose space-y-8 text-justify break-keep">
                                <p>
                                ...
                                <p className="text-center font-bold text-lg mt-8 text-sookmyung-blue-900">
                                    감사합니다.
                                </p>
                            </div>
                            ...
                            <div className="mt-12 pt-8 border-t border-gray-100 text-center">
                                <p className="text-sookmyung-blue-900 text-lg font-bold">
                                    숙명여자대학교 총동문회
                                </p>
                            </div>
                        </Card>
