      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-6">
          {[
            ...
            { key: 'payment', label: '결제 완료 (확정)', desc: '결제가 완료되어 참가가 확정되었을 때 발송됩니다. 변수: #{name}, #{amount}, #{orderId}' },
            { key: 'cancel', label: '결제 취소 (환불)', desc: '결제가 취소되었을 때 발송됩니다. 변수: #{name}, #{amount}, #{reason}' },
